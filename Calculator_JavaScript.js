...
function Handle_Operator(Next_Operator) {
    ...
    //When an operator key is pressed, we convert the current number displayed on the screen to a number and then store
...
//This function updates the screen with the contents of Diplay_Value
...
keys.addEventListener('click', (event) => {
    //The taget variable is an object that represents the element that was clicked
    const {target} = event;
